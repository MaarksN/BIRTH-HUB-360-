...
export default function ToolPage({ params }: { params: { toolId: string } }) {
  const tool = REVOPS_TOOLS.find((t) => t.id === params.toolId);
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
            <CardHeader>
                ...
                <CardDescription>Configure the RevOps Agent parameters.</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="space-y-4">
                    ...
                    <Button onClick={handleExecute} disabled={loading}>
                        {loading ? "Optimizing..." : "Execute Agent"}
                    </Button>
                </div>
            </CardContent>
        </Card>
